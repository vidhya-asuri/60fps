...
var selectRandomMeat = function() {
  var randomMeat = pizzaIngredients.meats[Math.floor((Math.random() * pizzaMeats_length))];
  return randomMeat;
};

var selectRandomNonMeat = function() {
  var randomNonMeat = pizzaIngredients.nonMeats[Math.floor((Math.random() * pizzaNonMeats_length))];
  return randomNonMeat;
};

var selectRandomCheese = function() {
  var randomCheese = pizzaIngredients.cheeses[Math.floor((Math.random() * pizzaCheeses_length))];
  return randomCheese;
};

var selectRandomSauce = function() {
  var randomSauce = pizzaIngredients.sauces[Math.floor((Math.random() * pizzaSauces_length))];
  return randomSauce;
};

var selectRandomCrust = function() {
  var randomCrust = pizzaIngredients.crusts[Math.floor((Math.random() * pizzaCrusts_length))];
  return randomCrust;
};
...
var makeRandomPizza = function() {
  ...
  for (var i = 0; i < numberOfMeats; i++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.meats[Math.floor((Math.random() * pizzaMeats_length))]);
    //pizza = pizza + ingredientItemizer(selectRandomMeat());
  }

  for (var j = 0; j < numberOfNonMeats; j++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.nonMeats[Math.floor((Math.random() * pizzaNonMeats_length))]);  	
    //pizza = pizza + ingredientItemizer(selectRandomNonMeat());
  }

  for (var k = 0; k < numberOfCheeses; k++) {
    pizza = pizza + ingredientItemizer(pizzaIngredients.cheeses[Math.floor((Math.random() * pizzaCheeses_length))]);  	
...
*/
  ...
  function changePizzaSizes(size) {
    ...
    for (var i = 0; i < numRandomPizzaContainers; i++) {
      randomPizzaContainers[i].style.width = dx + '%';
    }
  }
...
function calculatePhase(){
  ...
  var phase = [];
  for (var i = 0; i < 10; i++) {
    var tempPhaseValue = Math.sin((document.body.scrollTop / 1250) + (i % 5));
    phase[i] =  (100 * tempPhaseValue);
  }

  return phase;
};

var phase = calculatePhase();
...
function updatePositions() {
  ...
  var itemsLength = document.querySelectorAll('.mover').length;
